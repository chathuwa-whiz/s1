...
class ProductsModel{
	...
	static public function mdlAddProduct($table, $data){
		...
		$stmt = Connection::connect()->prepare("INSERT INTO $table(idCategory, code, description, image, stock, buyingPrice, sellingPrice, discountPrice) VALUES (:idCategory, :code, :description, :image, :stock, :buyingPrice, :sellingPrice, :discountPrice)");
